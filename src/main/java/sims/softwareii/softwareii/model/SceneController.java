...
//        switchScene("/sims/softwarei/main-menu.fxml", event);
//
//    }
//
//    /**
//     * Switches the current scene to the Add Part screen when called.
//     *
//     * @param event The event initially calling the action to switch scenes.
//     */
//    @FXML
//    public static void switchToAddPartScreen(ActionEvent event) {
//        switchScene("/sims/softwarei/add-part.fxml", event);
//
//    }
//
//    /**
//     * Switches the current scene to the Modify Part screen when called.
//     *
//     * @param event The event initially calling the action to switch scenes.
//     */
//    @FXML
//    public static void switchToModifyPartScreen(ActionEvent event) {
//        switchScene("/sims/softwarei/modify-part.fxml", event);
//    }
//
//    /**
//     * Switches the current scene to the Add Product screen when called.
//     *
//     * @param event The event initially calling the action to switch scenes.
//     */
//    @FXML
//    public static void switchToAddProductScreen(ActionEvent event) {
//        switchScene("/sims/softwarei/add-product.fxml", event);
//    }
//
//    /**
//     * Switches the current scene to the Modify Product screen when called.
//     *
//     * @param event The event initially calling the action to switch scenes.
//     */
//    @FXML
//    public static void switchToModifyProductScreen(ActionEvent event) {
//        switchScene("/sims/softwarei/modify-product.fxml", event);
//    }
